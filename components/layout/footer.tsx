...
const footerLinks = {
  ...
  services: [
    { name: 'Buy a Home', href: '/properties?type=sale' },
    { name: 'Rent a Home', href: '/properties?type=rent' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Your trusted partner in finding the perfect home. We make real estate transactions simple, fast, and transparent.
            </p>
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2 text-gray-400">
                ...
                <span>info@estateflow.com</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
                <MapPin className="h-4 w-4" />
                <span>123 Real Estate St, City, ST 12345</span>
              </div>
            </div>
          </div>
